...
const dictionaries = {
  zh: {
    ...
    projectDescriptions: {
      ...
      AIBT: "AI Behavior Test — 让 AI 通过分析你的对话历史，给你做一份行为画像。[查看介绍](https://img.bryantchen.cc/slides/aibt-intro)",
    },
  ...
  en: {
    ...
    projectDescriptions: {
      ...
      AIBT: "AI Behavior Test — AI analyzes your conversation history to build a behavioral profile of you. [View intro](https://img.bryantchen.cc/slides/aibt-intro)",
    },
    chromeExtensionDescriptions: {
      "拾刻 (Shike)":
